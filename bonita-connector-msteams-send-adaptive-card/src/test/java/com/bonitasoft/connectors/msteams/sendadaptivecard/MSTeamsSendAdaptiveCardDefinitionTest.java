 ...
 */
@DisplayName("MS Teams SendAdaptiveCard Connector Definition Tests")
class MSTeamsSendAdaptiveCardDefinitionTest {
    ...
    static void loadDefinition() throws Exception {
        String defPath = "msteams-send-adaptive-card.def";
        InputStream defIs = MSTeamsSendAdaptiveCardDefinitionTest.class
                .getClassLoader()
    ...
    void should_have_valid_connector_id() {
        ...
        assertThat(connectorId).isEqualTo("msteams-send-adaptive-card");
    }
    ...
    void should_have_widget_labels_in_properties() {
        InputStream propsIs =
                getClass()
                        .getClassLoader()
                        .getResourceAsStream("msteams-send-adaptive-card.properties");
