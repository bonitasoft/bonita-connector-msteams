 ...
 */
@DisplayName("MS Teams ListTeams Connector Definition Tests")
class MSTeamsListTeamsDefinitionTest {
    ...
    static void loadDefinition() throws Exception {
        String defPath = "msteams-list-teams.def";
        InputStream defIs = MSTeamsListTeamsDefinitionTest.class
                .getClassLoader()
    ...
    void should_have_valid_connector_id() {
        ...
        assertThat(connectorId).isEqualTo("msteams-list-teams");
    }
    ...
    void should_have_widget_labels_in_properties() {
        InputStream propsIs =
                getClass()
                        .getClassLoader()
                        .getResourceAsStream("msteams-list-teams.properties");
