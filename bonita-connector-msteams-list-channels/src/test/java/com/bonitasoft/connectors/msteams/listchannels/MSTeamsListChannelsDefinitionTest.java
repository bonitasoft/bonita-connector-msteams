 ...
 */
@DisplayName("MS Teams ListChannels Connector Definition Tests")
class MSTeamsListChannelsDefinitionTest {
    ...
    static void loadDefinition() throws Exception {
        String defPath = "msteams-list-channels.def";
        InputStream defIs = MSTeamsListChannelsDefinitionTest.class
                .getClassLoader()
    ...
    void should_have_valid_connector_id() {
        ...
        assertThat(connectorId).isEqualTo("msteams-list-channels");
    }
    ...
    void should_have_widget_labels_in_properties() {
        InputStream propsIs =
                getClass()
                        .getClassLoader()
                        .getResourceAsStream("msteams-list-channels.properties");
