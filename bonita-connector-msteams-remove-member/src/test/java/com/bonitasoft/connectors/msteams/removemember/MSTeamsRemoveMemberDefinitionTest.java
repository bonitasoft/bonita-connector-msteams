 ...
 */
@DisplayName("MS Teams RemoveMember Connector Definition Tests")
class MSTeamsRemoveMemberDefinitionTest {
    ...
    static void loadDefinition() throws Exception {
        String defPath = "msteams-remove-member.def";
        InputStream defIs = MSTeamsRemoveMemberDefinitionTest.class
                .getClassLoader()
    ...
    void should_have_valid_connector_id() {
        ...
        assertThat(connectorId).isEqualTo("msteams-remove-member");
    }
    ...
    void should_have_widget_labels_in_properties() {
        InputStream propsIs =
                getClass()
                        .getClassLoader()
                        .getResourceAsStream("msteams-remove-member.properties");
