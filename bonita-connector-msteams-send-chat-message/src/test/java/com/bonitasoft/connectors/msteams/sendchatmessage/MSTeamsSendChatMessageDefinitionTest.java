 ...
 */
@DisplayName("MS Teams SendChatMessage Connector Definition Tests")
class MSTeamsSendChatMessageDefinitionTest {
    ...
    static void loadDefinition() throws Exception {
        String defPath = "msteams-send-chat-message.def";
        InputStream defIs = MSTeamsSendChatMessageDefinitionTest.class
                .getClassLoader()
    ...
    void should_have_valid_connector_id() {
        ...
        assertThat(connectorId).isEqualTo("msteams-send-chat-message");
    }
    ...
    void should_have_widget_labels_in_properties() {
        InputStream propsIs =
                getClass()
                        .getClassLoader()
                        .getResourceAsStream("msteams-send-chat-message.properties");
