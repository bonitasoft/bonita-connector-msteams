...
public class RetryPolicy {
    ...
    public <T> T execute(Callable<T> action) throws MSTeamsException {
        int attempt = 0;
        while (true) {
            try {
                return action.call();
                ...
                throw new MSTeamsException("Unexpected error during API call", e);
            }
        }
    }
    ...
    void sleep(long millis) {
        try {
            ...
            throw new MSTeamsException("Retry interrupted", e);
        }
    }
}
