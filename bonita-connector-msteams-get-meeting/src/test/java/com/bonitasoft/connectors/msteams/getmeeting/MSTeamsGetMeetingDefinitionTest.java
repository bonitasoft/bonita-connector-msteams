 ...
 */
@DisplayName("MS Teams GetMeeting Connector Definition Tests")
class MSTeamsGetMeetingDefinitionTest {
    ...
    static void loadDefinition() throws Exception {
        String defPath = "msteams-get-meeting.def";
        InputStream defIs = MSTeamsGetMeetingDefinitionTest.class
                .getClassLoader()
    ...
    void should_have_valid_connector_id() {
        ...
        assertThat(connectorId).isEqualTo("msteams-get-meeting");
    }
    ...
    void should_have_widget_labels_in_properties() {
        InputStream propsIs =
                getClass()
                        .getClassLoader()
                        .getResourceAsStream("msteams-get-meeting.properties");
