 ...
 */
@DisplayName("MS Teams ReplyMessage Connector Definition Tests")
class MSTeamsReplyMessageDefinitionTest {
    ...
    static void loadDefinition() throws Exception {
        String defPath = "msteams-reply-message.def";
        InputStream defIs = MSTeamsReplyMessageDefinitionTest.class
                .getClassLoader()
    ...
    void should_have_valid_connector_id() {
        ...
        assertThat(connectorId).isEqualTo("msteams-reply-message");
    }
    ...
    void should_have_widget_labels_in_properties() {
        InputStream propsIs =
                getClass()
                        .getClassLoader()
                        .getResourceAsStream("msteams-reply-message.properties");
