 ...
 */
@DisplayName("MS Teams DeleteChannel Connector Definition Tests")
class MSTeamsDeleteChannelDefinitionTest {
    ...
    static void loadDefinition() throws Exception {
        String defPath = "msteams-delete-channel.def";
        InputStream defIs = MSTeamsDeleteChannelDefinitionTest.class
                .getClassLoader()
    ...
    void should_have_valid_connector_id() {
        ...
        assertThat(connectorId).isEqualTo("msteams-delete-channel");
    }
    ...
    void should_have_widget_labels_in_properties() {
        InputStream propsIs =
                getClass()
                        .getClassLoader()
                        .getResourceAsStream("msteams-delete-channel.properties");
