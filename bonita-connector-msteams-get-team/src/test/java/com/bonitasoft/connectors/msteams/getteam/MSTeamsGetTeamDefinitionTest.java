 ...
 */
@DisplayName("MS Teams GetTeam Connector Definition Tests")
class MSTeamsGetTeamDefinitionTest {
    ...
    static void loadDefinition() throws Exception {
        String defPath = "msteams-get-team.def";
        InputStream defIs = MSTeamsGetTeamDefinitionTest.class
                .getClassLoader()
    ...
    void should_have_valid_connector_id() {
        ...
        assertThat(connectorId).isEqualTo("msteams-get-team");
    }
    ...
    void should_have_widget_labels_in_properties() {
        InputStream propsIs =
                getClass()
                        .getClassLoader()
                        .getResourceAsStream("msteams-get-team.properties");
