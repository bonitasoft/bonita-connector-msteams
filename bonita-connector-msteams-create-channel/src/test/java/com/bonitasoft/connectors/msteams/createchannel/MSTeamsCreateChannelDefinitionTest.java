 ...
 */
@DisplayName("MS Teams CreateChannel Connector Definition Tests")
class MSTeamsCreateChannelDefinitionTest {
    ...
    static void loadDefinition() throws Exception {
        String defPath = "msteams-create-channel.def";
        InputStream defIs = MSTeamsCreateChannelDefinitionTest.class
                .getClassLoader()
    ...
    void should_have_valid_connector_id() {
        ...
        assertThat(connectorId).isEqualTo("msteams-create-channel");
    }
    ...
    void should_have_widget_labels_in_properties() {
        InputStream propsIs =
                getClass()
                        .getClassLoader()
                        .getResourceAsStream("msteams-create-channel.properties");
