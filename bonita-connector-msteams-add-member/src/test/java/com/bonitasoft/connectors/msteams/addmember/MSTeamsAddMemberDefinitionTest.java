 ...
 */
@DisplayName("MS Teams AddMember Connector Definition Tests")
class MSTeamsAddMemberDefinitionTest {
    ...
    static void loadDefinition() throws Exception {
        String defPath = "msteams-add-member.def";
        InputStream defIs = MSTeamsAddMemberDefinitionTest.class
                .getClassLoader()
    ...
    void should_have_valid_connector_id() {
        ...
        assertThat(connectorId).isEqualTo("msteams-add-member");
    }
    ...
    void should_have_widget_labels_in_properties() {
        InputStream propsIs =
                getClass()
                        .getClassLoader()
                        .getResourceAsStream("msteams-add-member.properties");
