 ...
 */
@DisplayName("MS Teams UploadFile Connector Definition Tests")
class MSTeamsUploadFileDefinitionTest {
    ...
    static void loadDefinition() throws Exception {
        String defPath = "msteams-upload-file.def";
        InputStream defIs = MSTeamsUploadFileDefinitionTest.class
                .getClassLoader()
    ...
    void should_have_valid_connector_id() {
        ...
        assertThat(connectorId).isEqualTo("msteams-upload-file");
    }
    ...
    void should_have_widget_labels_in_properties() {
        InputStream propsIs =
                getClass()
                        .getClassLoader()
                        .getResourceAsStream("msteams-upload-file.properties");
