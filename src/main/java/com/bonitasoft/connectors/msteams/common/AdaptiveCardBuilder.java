 ...
 * Produces a webhook-compatible envelope with the card as attachment.
 * <p>
 * Size limit: 28KB for Teams webhook payloads.
 */
public class AdaptiveCardBuilder {
    ...
    /**
     * Build the Adaptive Card JSON wrapped in a webhook-compatible envelope.
     *
     * @return ObjectNode ready to send via webhook
    ...
    /**
     * Wrap a raw Adaptive Card JSON string in the webhook envelope.
     *
